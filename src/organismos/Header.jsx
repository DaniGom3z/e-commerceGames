  ...
  return (
    <header className=' bg-nav-color flex justify-between items-center h-16 pl-16'>
      ...
      <div className='flex space-x-4'>
        <Link href="#juegos" text="Juegos" className='text-black hover:text-white' />
        <Link href="#acerca" text="Acerca" className='text-black hover:text-white' />
      </div>
